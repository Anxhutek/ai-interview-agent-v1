...
export default function Home() {
  ...
  const [formId, setFormId] = useState('cand-001');
        ...
        <section className="relative z-10 w-full max-w-6xl my-auto animate-slide-up space-y-12 py-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              {/* Interview Start Form - No login required */}
              <div className="glass-card rounded-2xl p-6 md:p-8 border border-zinc-800 shadow-2xl">
                <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-zinc-800/60">
                  <div className="h-12 w-12 rounded-xl bg-gradient-to-tr from-indigo-500 to-violet-600 flex items-center justify-center shadow-md shadow-indigo-500/20">
                  ...
                  <div>
                    <h2 className="text-base font-bold text-zinc-100 font-outfit">
                      {user ? `Ready, ${user.fullName.split(' ')[0]}?` : 'Start Your Interview'}
                    </h2>
                    <p className="text-xs text-indigo-400 font-medium">No sign-in required</p>
                  </div>
                </div>
