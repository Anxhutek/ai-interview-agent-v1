...
export default function AdminPage() {
  ...
  return (
    <main className="relative min-h-screen w-full flex flex-col items-center p-4 md:p-8 bg-[#09090b]">
      ...
      {!isAdmin ? (
        <>
          {/* Main Unauthenticated Screen */}
          <section className="relative z-10 w-full max-w-md my-auto flex flex-col items-center justify-center text-center animate-slide-up">
            <div className="h-20 w-20 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mb-6 shadow-xl shadow-black/40">
              <svg className="w-10 h-10 text-zinc-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
            </div>
            
            <h2 className="text-2xl font-bold tracking-tight text-zinc-100 font-outfit mb-3">
              Restricted Area
            </h2>
            <p className="text-sm text-zinc-400 mb-8 leading-relaxed max-w-sm">
              This portal is restricted to authorized administrators only. Please authenticate to access candidate reports and evaluation telemetry.
            </p>
            
            <button
              onClick={() => setIsAuthModalOpen(true)}
              className="px-6 py-3.5 bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-600 hover:to-violet-700 text-white text-sm font-semibold rounded-xl shadow-lg shadow-indigo-500/20 transition-all flex items-center space-x-2 active:scale-95"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {isAuthModalOpen && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
              <section className="relative w-full max-w-md glass-card rounded-2xl p-6 md:p-8 border border-zinc-800 shadow-2xl text-center">
                {/* Close Button */}
                <button
                ...
                <div className="h-16 w-16 rounded-2xl bg-gradient-to-tr from-violet-600 to-indigo-600 flex items-center justify-center mx-auto mb-4 shadow-xl shadow-indigo-500/20 mt-2">
